...
<div class="review-block">
    ...
    <div class="review-img-wrap"><img src="<?if($arItem['PREVIEW_PICTURE']['SRC']): echo ($arItem['PREVIEW_PICTURE']['SRC']); else: echo '/local/templates/exam1/img/rew/no_photo.jpg'; endif;?>" alt="img"></div>
</div>
<?endforeach;?>
